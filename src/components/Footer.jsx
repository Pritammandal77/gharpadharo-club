...
const Footer = () => {
    ...
    return (
        <>
            <footer className="bg-[#262626] text-white py-12 px-4 font-inter border-t border-gray-800 overflow-x-hidden">
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:w-[90vw]">
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-5 pt-2">
                            ...
                            <a
                                ...
                                target="_blank"
                                className="text-gray-500 dark:text-gray-400 hover:text-purple-500 transition-transform transform hover:scale-110"
                            >
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <a
                                    href="#joinUs"
                                    className="text-gray-300 hover:text-purple00 transition-colors duration-300"
                                >
                                    Join Us
                                </a>
                            </li>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            <li className="text-gray-300 hover:text-purple-500 transition-colors duration-300">
                ...
                { }
                <div className="text-center text-gray-400 text-sm pt-10 mt-10 border-t border-gray-200 dark:border-gray-700">
