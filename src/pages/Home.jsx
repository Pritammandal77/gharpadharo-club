...
function Home() {
    return (
        <>
            <div className='w-full manrope-font h-[100vh] flex items-center justify-center bg-[#0f0f0f]  bg-[url("/homeImgXl2.jpg")] bg-cover bg-center bg-fixed overflow-x-hidden' id='home'>
